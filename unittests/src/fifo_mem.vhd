...
-- Module  Version: 6.5
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n fifo_mem -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo3c00a -type bram -wp 10 -rp 0011 -rdata_width 8 -data_width 8 -num_rows 1024 -outdata REGISTERED -cascade -1 -resetmode SYNC -sync_reset -mem_init0 

-- Sun Oct 27 14:44:57 2019
...
architecture Structure of fifo_mem is
    ...
    attribute MEM_LPC_FILE of fifo_mem_0_0_0 : label is "fifo_mem.lpc";
    attribute MEM_INIT_FILE of fifo_mem_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of fifo_mem is
    for Structure
